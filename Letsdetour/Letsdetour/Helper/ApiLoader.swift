...
enum PromissionType {
    ...
    func get() -> String {
        ...
        switch self {
        case .Camera:
            return "\(appName) will access your Phone Camera for SOS recording or Profile Image."
        case .Location:
            return "\(appName) will access your Location for SOS to your Emergency contacts."
        case .Gallery:
            return "\(appName) will access your phone library for SOS recording or Profile Image."
        case .Audio:
            return "\(appName) will Need microphone access for SOS recording "
        case .Contacts:
