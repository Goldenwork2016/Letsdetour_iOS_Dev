...
struct TextStrings {
    ...
    struct MESSAGE {
        ...
        static let LocationRequired =  "We need your location permission to send your location with SOS, please enable from your phone settings"
        ...
        static let EMPTY_Password =  "Your password should be at least 5 digit long, should include at least 1 numeric character".SetLang()
